...
export const MODULE_REGISTRY = [
  ...
  { id: 'technicians', name: 'Teknisi', layer: 'runtime', status: 'stable', pages: ['technicians'] },
  { id: 'assets', name: 'Unit AC', layer: 'runtime', status: 'stable', pages: ['assets'] },
...
export const BLUEPRINTS: BlueprintDef[] = [
  ...
  {
    id: 'salon_kamar_mandi',
    name: 'Salon Kamar Mandi',
    category: 'jasa',
    categoryLabel: 'Jasa',
    templateId: 'service_salon_v1',
    description: 'Booking, jadwal teknisi, work order, invoice, kas, dan laporan untuk jasa pembersihan/restorasi kamar mandi.',
    modules: SERVICE_CORE,
    available: true,
    kind: 'service',
    catalog: HIDDEN_NON_CORE,
    /** Blueprint Jasa V1 skin — RELEASED 1.0.0 · 2026-07-19 · Code Freeze. */
    extension: {
      ...
      bootstrap: {
        ...
        items: [
          { name: 'Pembersihan Kamar Mandi Standar', category: 'Pembersihan', unit: 'unit', price: 250000 },
          { name: 'Restorasi Keramik & Nat', category: 'Restorasi', unit: 'unit', price: 450000 },
        ],
      },
    },
  },
  {
    id: 'cuci_sofa_furniture',
    name: 'Cuci Sofa & Furniture',
    category: 'jasa',
    categoryLabel: 'Jasa',
    templateId: 'service_sofa_v1',
    description: 'Pesanan cuci sofa/kasur/karpet, survey opsional, work order, pembayaran, dan rekap keuangan.',
    modules: SOFA_MODULES,
    available: true,
    kind: 'service',
    catalog: HIDDEN_NON_CORE,
    extension: {
      ...
      bootstrap: {
        strategy: 'seed_service_items',
        items: [
          { name: 'Cuci Sofa 2 Seater', category: 'Sofa', unit: 'unit', price: 175000 },
          { name: 'Cuci Kasur', category: 'Kasur', unit: 'unit', price: 200000 },
        ],
      },
    },
  },
  {
    ...
    category: 'jasa',
    categoryLabel: 'Jasa',
    templateId: 'service_ac_v1',
    description: 'Registrasi unit AC, booking servis, work order teknisi, riwayat servis, invoice, dan laporan.',
    modules: AC_MODULES,
    available: true,
    kind: 'service',
    catalog: HIDDEN_NON_CORE,
    extension: {
      ...
      bootstrap: {
        strategy: 'seed_service_items',
        items: [
          { name: 'Cuci AC Split 0.5–1 PK', category: 'Cuci', unit: 'unit', price: 75000 },
          { name: 'Servis AC + Freon Check', category: 'Servis', unit: 'unit', price: 150000 },
        ],
      },
    },
  },
